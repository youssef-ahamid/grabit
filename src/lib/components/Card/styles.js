export const card = (props) => {
  return [
    {
      classes:
        "rounded-xl m-2 p-4 md:p-6 transition-300 shadow-xl h-auto hover:shadow-2xl hover:scale-105 flex flex-col space-y-4 text-left min-w-fit max-w-[18rem] h-full flex flex-col justify-between z-10 relative",
      styles: "",
      on: true, // default
    },
    {
